...
BH1750 __bh1750_light_sensor;

// High res: 0.5 lux, 120ms measure time
// Low res: 4 lux, 16ms measure time
void setup_bh1750_light_sensor(bool highres = false) {
    Wire.begin();
    __bh1750_light_sensor.begin(highres ? BH1750::CONTINUOUS_HIGH_RES_MODE_2 : BH1750::CONTINUOUS_LOW_RES_MODE);
}

float measure_light_level_lux() {
    return __bh1750_light_sensor.readLightLevel();
}
